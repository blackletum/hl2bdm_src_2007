...
CAmmoDef *GetAmmoDef()
{
	...
	if ( !bInitted )
	{
		...
		def.AddAmmoType("FlareRound",		DMG_BURN,					TRACER_LINE,			0,			0,			20,			BULLET_IMPULSE(1500, 600),	0 );
		def.AddAmmoType("MediumRound",		DMG_BULLET,					TRACER_LINE_AND_WHIZ,	0,			0,			150,		BULLET_IMPULSE(200, 1225),	0 );
		def.AddAmmoType("Hopwire",			DMG_BURN,					TRACER_NONE,			0,			0,			5,			0,							0 );
		def.AddAmmoType("HeavyRound",		DMG_BULLET,					TRACER_LINE_AND_WHIZ,	0,			0,			60,			BULLET_IMPULSE(200, 1225),	0 );
		def.AddAmmoType("AlyxRound",		DMG_BULLET,					TRACER_LINE_AND_WHIZ,	0,			0,			150,		BULLET_IMPULSE(200, 1225),	0 );
		def.AddAmmoType("SMG2",				DMG_BULLET,					TRACER_LINE_AND_WHIZ,	0,			0,			255,		BULLET_IMPULSE(200, 1225),	0 );
		def.AddAmmoType("NerfRound",		DMG_BULLET,					TRACER_NONE,			0,			0,			18,			BULLET_IMPULSE(200, 1225),	0 );
	}
