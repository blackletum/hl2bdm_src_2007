...
void CHL2MP_Player::GiveAllItems( void )
{
	...
	CBasePlayer::GiveAmmo( 150,	"MediumRound" );
	CBasePlayer::GiveAmmo( 20,	"FlareRound" );
	CBasePlayer::GiveAmmo( 30,	"Rifle" );
	//CBasePlayer::GiveAmmo( 5,	"Hopwire" );
	CBasePlayer::GiveAmmo( 60,	"HeavyRound" );
	...
	//GiveNamedItem( "weapon_hop" );

	GiveNamedItem( "weapon_sniper" );

	GiveNamedItem( "weapon_hmg1" );

	GiveNamedItem( "weapon_alyx_gun" );
...
void CHL2MP_Player::GiveDefaultItems( void )
{
	...
	CBasePlayer::GiveAmmo( 60,	"MediumRound" );
	CBasePlayer::GiveAmmo( 10,	"FlareRound" );
	CBasePlayer::GiveAmmo( 10,	"Rifle" );
	//CBasePlayer::GiveAmmo( 1,	"Hopwire" );
	CBasePlayer::GiveAmmo( 30,	"HeavyRound" );
...
void CHL2MP_Player::SetPlayerTeamModel( void )
{
	...
	{
		if ( Q_stristr( szModelName, "models/player/group03") )
		{
...
{
	if ( Q_stristr( pModelName, "models/player/group03") )
	{
